...
class Book {
     ...
     * of the title, author,
     * year of publication and the total literary value of the book, separated by
    ...
    int getLiteraryValue(){
        int drama = this.dramaticValue;
        int comic =  this.comicValue;
        int educ = this.educationalValue;
